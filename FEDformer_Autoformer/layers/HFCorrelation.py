...
class HFCorrelation(nn.Module):
    ...
    """
    def __init__(self, mask_flag=True, factor=1, attention_dropout=0.1, output_attention=False, topk_prob=0.2):
        super(HFCorrelation, self).__init__()
        self.factor = factor
...
class HFCorrelationLayer(nn.Module):
    def __init__(self, correlation, d_model, n_heads, d_keys=None, d_values=None):
        super(HFCorrelationLayer, self).__init__()
