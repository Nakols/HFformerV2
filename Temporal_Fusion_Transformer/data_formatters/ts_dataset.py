    ...
    def __init__(self,id_col, static_cols, time_col, input_cols,
        ...
        for identifier, df in data.groupby(id_col):
            ...
            if num_entries >= self.time_steps:
                valid_sampling_locations += [ (identifier, self.time_steps + i) for i in range(num_entries - self.time_steps + 1)]
        ...
        if max_samples > 0 and len(valid_sampling_locations) > max_samples:
            ...
            if self.random:
              ...
              ranges = [valid_sampling_locations[i] for i in range(max_samples)]
        else:
